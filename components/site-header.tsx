...
import { Award, Bell, LogOut, Menu, Package, Search, ShoppingCart, User, X, Trophy } from "lucide-react"
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center overflow-x-hidden">
        ...
        <div className="hidden md:flex">{/* Other navigation items */}</div>
        <nav className="hidden md:flex items-center gap-6 text-sm">
          ...
          <Link
            ...
            className={cn(
              ...
              pathname === "/auctions" ? "text-black dark:text-white" : "text-muted-foreground",
            )}
          >
            Auctions
          </Link>
          ...
          <Link
            ...
            className={cn(
              "text-sm font-medium transition-colors hover:text-primary",
              pathname === "/rumble" ? "text-black dark:text-white" : "text-muted-foreground",
            )}
          >
            Rumble
          </Link>
        ...
        <div className="flex items-center ml-auto gap-2">
          ...
          {/* Always show authenticated UI with our dummy implementation */}
          <>
          ...
          {/* Always show user profile dropdown with our dummy implementation */}
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="rounded-full h-8 w-8 ml-1">
                <Avatar className="h-8 w-8">
                  <AvatarImage
                    src={user?.profileImage || "/placeholder.svg?height=40&width=40&query=pokemon trainer"}
                    alt={user?.name || "Pokémon Trainer"}
                  />
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem>
                <Link href="/loyalty" className="flex w-full">
                  ...
                  Loyalty Points ({user?.points || 750})
                </Link>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
