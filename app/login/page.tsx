    ...
    try {
      ...
      switch (response?.loginState) {
        case LoginState.SUCCESS:
          ...
          // Changed from /account to / (homepage)
          const redirectUrl = "/"
  ...
  return (
    <div className="h-[calc(100vh-80px)] px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 flex items-center justify-center">
      <form className="flex flex-col gap-8 w-full max-w-md" onSubmit={handleSubmit}>
        ...
        <button
          className="bg-blue-600 text-white p-2 rounded-md disabled:bg-blue-300 disabled:cursor-not-allowed"
          disabled={isLoading}
        >
        ...
        <div className="text-center mt-4">
          <Link href="/token-login" className="text-xs text-gray-500 hover:underline">
            Developer Login
          </Link>
        </div>
      </form>
